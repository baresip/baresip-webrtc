...
find_path(RE_INCLUDE_DIR re.h HINTS ${PC_LIBRE_INCLUDEDIR} ${PC_LIBRE_INCLUDE_DIRS})

find_library(RE_LIBRARY NAMES re libre HINTS ${PC_LIBRE_LIBDIR} ${PC_LIBRE_LIBRARY_DIRS})
